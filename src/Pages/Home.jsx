            ...
            >
              ...
              <div className="container justify-content-center align-items-center mt-5">
                <div className="row">
                  <div className="col-12 col-md-12">
                    <p className="fw-bold fs-2 ">Celebrate Special Moments</p>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div className="card card1 col-11 col-md-11 col-lg-7 mt-0 ms-3 ms-md-4 mt-md-4 mt-4 mt-lg-0 mt-xl-0 mt-xxl-0 shadow-sm border border-light">
                      <p
                        className="mt-2 h4 lh-base fs-3 fw-bold"
                        style={{ fontFamily: "Kalam, cursive" }}
                      >
                        Did we just become best friends?
                      </p>
                      <p
                        className="mt-2 lh-base"
                        style={{
                          fontSize: "22px",
                          fontFamily: "Cedarville Cursive, cursive, sans-serif",
                        }}
                      >
              ...
              <div className="border border-light mt-5 ">
                <div className="container mt-5">
                  <div className="row">
                    <div className="col-12 col-md-12 ">
                      <p className="fw-bold fs-2">Capturing Your Love Story</p>
                    </div>
                  </div>
                  <div className="row">
                    <div
